...
|__/  |__/ \____  $$ \_______/|__/      \_______/        \_______/|__/ \_______/|__/      |__/ |__/ |__/
          ...
          |  $$$$$$/                                                                                    
           \______/
German locale for hydra_alarm
--]]

RegisterHydraLocale('de', {
    ['notify.alarm_triggered'] = 'Alarm ausgelöst: %s',
    ['notify.alarm_stopped'] = 'Alarm gestoppt: %s',
    ['notify.no_permission'] = 'Dir ist nicht erlaubt, diesen Befehl auszuführen.',
    ['notify.stop_all_success'] = 'Alle Alarme für alle Spieler gestoppt.',
